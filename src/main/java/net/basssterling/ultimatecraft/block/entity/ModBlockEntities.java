...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<StrainerBlockEntity> STRAINER_BE =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of("ultimatecraft","strainer_be"),
                    BlockEntityType.Builder.create(StrainerBlockEntity::new, ModBlocks.STRAINER).build(null));
